    ...
    if (typeof window !== "undefined") {
      ...
      const svgCode = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <circle cx="16" cy="16" r="16" fill="${theme.bg}" />
            <text x="16" y="24" font-family="sans-serif" font-size="24" font-weight="bold" text-anchor="middle" fill="${theme.accent}">
            P
            </text>
        </svg>`.trim();
      ...
      favicon.setAttribute(
        "href",
        `data:image/svg+xml,${encodeURIComponent(svgCode)}#v=${version}`,
      );
    }
  };
            ...
            {THEMES.map((theme) => (
              ...
              >
                ...
                <div className="flex gap-1">
                  <div
                    className="w-3 h-3 rounded-full border border-text-dim/20"
