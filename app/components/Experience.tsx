...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-24 scroll-mt-20">
      ...
      <div className="font-serif flex flex-col md:flex-row bg-surface border border-on-accent/10 rounded-xl overflow-hidden min-h-112.5">
        ...
        {/* Details Pane */}
        <div className="text-serif flex-1 p-8 md:p-12 bg-bg/30 overflow-y-auto">
          {active && (
            <div
              key={active.company}
            ...
            >
              ...
              <div>
                <p className="font-bold text-text-main mb-6 uppercase tracking-widest text-base">
                ...
                <ul className="space-y-4">
                  {active.achievements.map((item, i) => (
                    <li
                      key={i}
                      className="flex items-start gap-4 text-text-dim leading-relaxed"
                    >
